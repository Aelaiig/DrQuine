...
int main() {
    ...
    if (i > -1) {
        ...
        FILE *fp;
        fp = fopen(filePath, "w+");
        fprintf(fp, PROGRAM, PROGRAM, 10, 34, 37, i);
        fclose(fp);
